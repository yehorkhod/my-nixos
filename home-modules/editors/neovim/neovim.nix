...
in
{
  ...
  in
  {
    ...
    [
      ...
      luasnip nvim-dap-ui nvim-dap-python nvim-nio nvim-web-devicons plenary-nvim nui-nvim
      ...
      { plugin = nvim-colorizer-lua;   config = builtins.readFile ./configs/colorizer;                               }
      {
        plugin = (nvim-treesitter.withPlugins (p: [
          p.tree-sitter-haskell p.tree-sitter-c p.tree-sitter-python p.tree-sitter-r
          p.tree-sitter-bash p.tree-sitter-css p.tree-sitter-toml p.tree-sitter-nix
          p.tree-sitter-json p.tree-sitter-lua p.tree-sitter-yaml p.tree-sitter-ini
        ]));
