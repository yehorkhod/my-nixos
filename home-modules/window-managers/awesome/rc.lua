...
globalkeys = gears.table.join(
	...
	end, { description = "Dencrease Volume", group = "volume" }),
	...
	end, { description = "Dencrease Brightness", group = "brightness" }),

	-- Screenshot
	awful.key({ modkey, "Shift" }, "s", function()
		awful.spawn.with_shell(
			"shotgun -g $(hacksaw) /tmp/image.png && xclip -selection clipboard -t image/png -i /tmp/image.png"
		)
	...
	end, { description = "take full screenshot", group = "screenshot" }),
	...
	awful.key({ modkey }, "t", function()
		awful.spawn(messanger)
	end, { description = "open a messanger", group = "launcher" }),
